...
Propose the plugin's public repository and its directory in it. It is a proposal: the publisher confirms and verifies it on the dashboard's Install page.
